...
export class ApplicationFormComponent {
  ...
  readonly submittedSuccess = output<string>();
  ...
  readonly form = this.fb.nonNullable.group({
    ...
    experience: ['', [Validators.required, Validators.minLength(1), Validators.maxLength(80)]],
    ...
    this.careers
      ...
      .subscribe({
        next: (result) => {
          ...
          this.submittedSuccess.emit(result.id);
        },
        error: () => {
          this.submitting.set(false);
          this.error.set(

...
const categories = db.categories.map(c => c.id);
...
for(let i=0; i<50; i++) {
  ...
  const product = {
    ...
    brand: brand,
    description: `Experience the next generation of ${category} with the ${name}. Engineered for performance.`,
...
console.log('Added 50 products and EMI plans');
